...
const PaymentIcon = () => (
  <svg className="w-6 h-6 text-emerald-400" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
...
const Sidebar: React.FC<SidebarProps> = ({ collapsed, setCollapsed }) => {
  ...
  return (
    <div
      className={`flex flex-col h-full transition-all duration-300 ease-in-out bg-gray-900 text-white`}
    ...
    >
      ...
      <div className="flex items-center justify-between h-16 px-4 border-b border-gray-700 relative">
        <div className="flex items-center gap-2 select-none">
          <PaymentIcon />
          {!collapsed && <span className="font-bold text-xl">Payinme</span>}
        </div>
        ...
        <button
          ...
          className="absolute right-[-14px] top-1/2 transform -translate-y-1/2
            bg-gray-800 hover:bg-gray-700 border border-gray-700 rounded-full
      ...
      <nav className="flex flex-col justify-between flex-grow overflow-auto pt-2">
        <div>
          {menuItems.map(({ name, to, icon }) => (
            <NavLink
              ...
              to={to}
              className={({ isActive }) =>
                `flex items-center gap-4 px-4 py-3 hover:bg-emerald-700 transition-colors ${
                  isActive
        ...
        <div className="p-4">
          <button
            ...
            className={`flex items-center justify-center gap-2 border border-gray-700 text-white bg-gray-800 px-2 py-2 rounded-md transition-colors hover:bg-gray-700 ${
          ...
          <Dialog open={open} onClose={setOpen} className="relative z-10">
            ...
            <div className="fixed inset-0 z-10 overflow-y-auto">
              <div className="flex min-h-full items-center justify-center p-4">
                <DialogPanel className="w-full max-w-md transform overflow-hidden rounded bg-gray-800 p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-4 flex justify-end gap-3">
                    <button
                      ...
                      className="px-4 py-2 bg-gray-700 text-white rounded-md hover:bg-gray-600 border border-gray-600"
                    >
                      Cancel
                    </button>
                    <button
